...
<ul class="nav nav-tabs">
    <li <?php  if($do == 'global') { ?>class="active"<?php  } ?>>
        <a href="<?php  echo url('system/attachment/global')?>">
            全局设置
        </a>
    </li>
    <li <?php  if($do == 'remote') { ?>class="active"<?php  } ?>>
        <a href="<?php  echo url('system/attachment/remote')?>">
            远程附件
        </a>
    </li>
</ul>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="form-control-static">
                            1. 当前 PHP 环境允许最大单个上传文件大小为: <?php  echo $upload_max_filesize;?>
                        </div>
                        <div class="form-control-static">
                            2. 当前 PHP 环境允许最大 POST 表单大小为: <?php  echo $post_max_size;?>
                        </div>
                    </div>
                </div>
                <?php  } ?>
        ...
        <form action="" method="post" class="form-horizontal form" id="form">
            ...
            <div class="remote-ftp" <?php  if(empty($remote['type']) || $remote['type'] != '1') { ?> style="display:none;" <?php  } ?>>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <span class="help-block">
                            注意：选择是后，FTP 服务器必须开启了 SSL，一般情况选择否即可
                        </span>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <span class="help-block">
                            该帐号必须具有以下权限：读取文件、写入文件、删除文件、创建目录、子目录继承
                        </span>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <label class="radio-inline">
                            <input type="radio" name="ftp[pasv]" value="1" <?php  if(!empty($remote['ftp']['pasv'])) { ?> checked="checked" <?php  } ?>/>
                            是
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="ftp[pasv]" value="0" <?php  if(empty($remote['ftp']['pasv'])) { ?> checked="checked" <?php  } ?>/>
                            否
                        </label>
                        <span class="help-block">
                            一般情况下非被动模式即可，如果存在上传失败问题，可尝试打开此设置
                        </span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <span class="help-block">
                            远程附件目录的绝对路径或相对于 FTP 主目录的相对路径，结尾不要加斜杠 "/" , 例如：/attachment
                        </span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <span class="help-block">
                            支持 HTTP 和 FTP 协议，结尾不要加斜杠 "/" ; 例如：http://mydomin.com/attachment 如果使用 FTP 协议，FTP 服务器必须支持 PASV 模式，为了安全起见，
                            使用 FTP 连接的帐号不要设置可写权限和列表权限
                        </span>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <button name="button" type="button" class="btn btn-info js-checkremoteftp" value="check">
                        测试配置（无需保存）
                    </button>
                    <input type="hidden" name="token" value="<?php  echo $_W['token'];?>"/>
                </div>
            ...
            <div class="remote-alioss" <?php  if(empty($remote['type']) || $remote['type'] != '2') { ?> style="display:none;" <?php  } ?>>
                <div class="alert alert-info">
                    启用阿里oss后，请把/attachment目录（不包括此目录）下的子文件及子目录上传至阿里云oss, 相关工具：
                    <br/>
                    <ul class="link-list">
                        <li>
                            <a target="_blank" href="http://market.aliyun.com/products/52738003/cmgj000304.html?spm=5176.383663.9.21.faitxp" class="product-grey-font" data-spm-anchor-id="5176.383663.9.21">
                                cloudfs4oss(ECS挂载文件盘工具)
                            </a>
                        </li>
                        <li>
                            <a target="_blank" href="http://market.aliyun.com/products/53690006/cmgj000281.html?spm=5176.383663.9.22.faitxp" class="product-grey-font" data-spm-anchor-id="5176.383663.9.22">
                                官方推荐OSS客户端工具（Windows版）
                            </a>
                        </li>
                        <li>
                            <a target="_blank" href="http://market.aliyun.com/products/53690006/cmgj000282.html?spm=5176.383663.9.23.faitxp" class="product-grey-font" data-spm-anchor-id="5176.383663.9.23">
                                官方推荐OSS客户端工具（Mac版）
                            </a>
                        </li>
                        <li>
                            <a target="_blank" href="http://market.aliyun.com/products/53690006/cmgj000208.html?spm=5176.383663.9.24.faitxp" class="product-grey-font" data-spm-anchor-id="5176.383663.9.24">
                                Ftp4ossServer（OSS的FTP云工具）
                            </a>
                        </li>
                        <li>
                            <a target="_blank" href="http://bbs.aliyun.com/read/239565.html?spm=5176.383663.9.25.faitxp&amp;pos=2" class="product-grey-font" data-spm-anchor-id="5176.383663.9.25">
                                OSS图片服务Demo工具
                            </a>
                        </li>
                        <li>
                            <a target="_blank" href="http://docs.aliyun.com/?spm=5176.383663.9.26.faitxp#/pub/oss/utilities/osscmd&amp;install" class="product-grey-font" data-spm-anchor-id="5176.383663.9.26">
                                批量上传工具(Python)版
                            </a>
                        </li>
                        <li>
                            <a target="_blank" href="https://docs.aliyun.com/?spm=5176.383663.9.27.faitxp#/pub/oss/utilities/oss-import&amp;index" class="product-grey-font" data-spm-anchor-id="5176.383663.9.27">
                                OSS数据迁移工具-OSS Import
                            </a>
                        </li>
                        <li>
                            <a target="_blank" href="http://market.aliyun.com/products/52738004/cmfw000394.html?spm=5176.383663.9.28.faitxp" class="product-grey-font" data-spm-anchor-id="5176.383663.9.28">
                                海量数据迁移至OSS服务
                            </a>
                        </li>
                        <li>
                            <a target="_blank" href="http://bbs.aliyun.com/read/247023.html?spm=5176.383663.9.29.faitxp" class="product-grey-font" data-spm-anchor-id="5176.383663.9.29">
                                更多官方推荐工具
                            </a>
                        </li>
                    </ul>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="alioss[outBucket]" class="form-control" value="<?php  echo $remote['alioss']['outBucket'];?>" placeholder=""/>
                        <span class="help-block">
                            转码输出Bucket选择，一般和上面的Bucket相同，请手动输入。
                        </span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="alioss[pipelineId]" class="form-control" value="<?php  echo $remote['alioss']['pipelineId'];?>" placeholder=""/>
                        <span class="help-block">
                           转码管道ID。
                        </span>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="alioss[transcodeTemplateId]" class="form-control" value="<?php  echo $remote['alioss']['transcodeTemplateId'];?>" placeholder=""/>
                        <span class="help-block">
                            转码模板ID。
                        </span>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <button name="button" type="button" class="btn btn-info js-checkremoteoss" value="check">
                        测试配置（无需保存）
                    </button>
                    <input type="hidden" name="token" value="<?php  echo $_W['token'];?>"/>
                </div>
            ...
            <div class="remote-qiniu" <?php  if(empty($remote['type']) || $remote['type'] != '3') { ?> style="display:none;" <?php  } ?>>
                <div class="alert alert-info">
                    ...
                    <ul class="link-list">
                        <li>
                            <a target="_blank" href="https://portal.qiniu.com/signin" class="product-grey-font">
                                七牛云存储
                            </a>
                        </li>
                    </ul>
                ...
                <div class="form-group" id="qiniubucket">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="qiniu[pipelineName]" class="form-control" value="<?php  echo $remote['qiniu']['pipelineName'];?>" placeholder=""/>
                        <span class="help-block">
                            多媒体转换队列名称
                        </span>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <span class="help-block">
                            七牛支持用户自定义访问域名。注：url开头加http://或https://结尾不加 ‘/’例：http://abc.com
                        </span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <button name="button" type="button" class="btn btn-info js-checkremoteqiniu" value="check">
                        测试配置（无需保存）
                    </button>
                    <input type="hidden" name="token" value="<?php  echo $_W['token'];?>"/>
                </div>
            ...
            <div class="remote-cos" <?php  if(empty($remote['type']) || $remote['type'] != '4') { ?> style="display:none;" <?php  } ?>>
                <div class="alert alert-info">
                    启用腾讯云cos对象存储后，请把/attachment目录（不包括此目录）下的子文件及子目录上传至腾讯云存储, 相关工具：
                    <br/>
                    <ul class="link-list">
                        <li>
                            <a target="_blank" href="https://console.qcloud.com/cos/bucket" class="product-grey-font">
                                腾讯云存储
                            </a>
                        </li>
                    </ul>
                ...
                <div class="form-group" id="cos_local">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <select class="form-control" name="cos[local]">
                            <option value="" <?php  if($remote['cos']['local'] == '') { ?>selected<?php  } ?>>
                                无
                            </option>
                            <option value="tj" <?php  if($remote['cos']['local'] == 'tj') { ?>selected<?php  } ?>>
                                华北
                            </option>
                            <option value="sh" <?php  if($remote['cos']['local'] == 'sh') { ?>selected<?php  } ?>>
                                华东
                            </option>
                            <option value="gz" <?php  if($remote['cos']['local'] == 'gz') { ?>selected<?php  } ?>>
                                华南
                            </option>
                        </select>
                        <span class="help-block">
                            选择bucket对应的区域，如果没有选择无
                        </span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <span class="help-block">
                            腾讯云支持用户自定义访问域名。注：url开头加http://或https://结尾不加 ‘/’例：http://abc.com
                        </span>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <button name="button" type="button" class="btn btn-info js-checkremotecos" value="check">
                        测试配置（无需保存）
                    </button>
                    <input type="hidden" name="token" value="<?php  echo $_W['token'];?>"/>
                </div>
