var cityData = [{
        first: 'A',
        city: [{ code: '513200', name: '阿坝', py: 'aba', sx: 'ab' },
    ...
    {
        first: 'B',
        city: [{ code: '150800', name: '巴彦淖尔', py: 'bayannaoer', sx: 'byne' },
    ...
    {
        first: 'C',
        city: [{ code: '130900', name: '沧州', py: 'cangzhou', sx: 'cz' },
    ...
    {
        first: 'D',
        city: [{ code: '511700', name: '达州', py: 'dazhou', sx: 'dz' },
    ...
    {
        first: 'E',
        city: [{ code: '150600', name: '鄂尔多斯', py: 'eerduosi', sx: 'eeds' },
    ...
    {
        first: 'F',
        city: [{ code: '450600', name: '防城港', py: 'fangchenggang', sx: 'fcg' },
    ...
    {
        first: 'G',
        city: [{ code: '623000', name: '甘南', py: 'gannan', sx: 'gn' },
    ...
    {
        first: 'H',
        city: [{ code: '230100', name: '哈尔滨', py: 'haerbin', sx: 'heb' },
    ...
    {
        first: 'J',
        city: [{ code: '230300', name: '鸡西', py: 'jixi', sx: 'jx' },
    ...
    {
        first: 'K',
        city: [{ code: '653100', name: '喀什', py: 'kashen', sx: 'ks' },
    ...
    {
        first: 'L',
        city: [{ code: '540100', name: '拉萨', py: 'lasa', sx: 'ls' },
    ...
    {
        first: 'M',
        city: [{ code: '340500', name: '马鞍山', py: 'maanshan', sx: 'mas' },
    ...
    {
        first: 'N',
        city: [{ code: '542400', name: '那曲', py: 'neiqu', sx: 'nq' },
    ...
    {
        first: 'P',
        city: [{ code: '510400', name: '攀枝花', py: 'panzhihua', sx: 'pzh' },
    ...
    {
        first: 'Q',
        city: [{ code: '230900', name: '七台河', py: 'qitaihe', sx: 'qth' },
    ...
    {
        first: 'R',
        city: [{ code: '542300', name: '日喀则', py: 'rikaze', sx: 'rkz' },
            { code: '371100', name: '日照', py: 'rizhao', sx: 'rz' },
        ]
    },
    {
        first: 'S',
        city: [{ code: '411200', name: '三门峡', py: 'sanmenxia', sx: 'smx' },
    ...
    {
        first: 'T',
        city: [{ code: '654200', name: '塔城', py: 'tacheng', sx: 'tc' },
    ...
    {
        first: 'W',
        city: [{ code: '371000', name: '威海', py: 'weihai', sx: 'wh' },
    ...
    {
        first: 'X',
        city: [{ code: '610100', name: '西安', py: 'xian', sx: 'xa' },
    ...
    {
        first: 'Y',
        city: [{ code: '511800', name: '雅安', py: 'yaan', sx: 'ya' },
    ...
    {
        first: 'Z',
        city: [{ code: '370400', name: '枣庄', py: 'zaozhuang', sx: 'zz' },
