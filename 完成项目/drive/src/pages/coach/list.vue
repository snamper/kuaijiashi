                ...
                <div class="ui-page ui-page-current">
                    ...
                    <div class="choose" :style="[{'right': filter ? '0%' : '-100%'}]">
                        ...
                        <div class="chooseContent" style="padding-bottom: 112.141px;overflow:scroll;">
                            ...
                            <div class="ui-cell">驾照类型</div>
                            <div class="chooseBox">
                                <div class="labelCho">
                                    <span @click="setType('C1')" :class="type == 'C1' ? 'choActive' : ''">C1</span>
                                    <span @click="setType('C2')" :class="type == 'C2' ? 'choActive' : ''">C2</span>
                                    <span @click="setType('B2')" :class="type == 'B2' ? 'choActive' : ''">B2</span>
                                </div>
                            </div>
                            <div class="sex-box">
                                <div>所在城市</div>
