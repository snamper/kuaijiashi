                    ...
                    <div class="ui-content">
                        ...
                        <div>
                            ...
                            <div class="card-info">
                                ...
                                <div class="ui-cell item">
                                    <div class="ui-cell-lt" style="margin-right: 0.5rem;">教学车辆</div>
                                    <div class="ui-cell-primary">
                                        <div class="up-img">
                                            <div class="small-img">
                                ...
                                <div class="ui-cell item">
                                    <div class="ui-cell-lt" style="margin-right: 0.5rem;">教学场地</div>
                                    <div class="ui-cell-primary">
                                        <div class="up-img">
                                            <div class="small-img1">
                            ...
                            <div class="info-box">
                                <div class="ui-cell item-list">
                                    ...
                                    <div class="ui-cell-primary sex-box">
                                        <label class="ui-label-checkbox ui-item-content">
                                            <input type="radio" class="sex sex-man" v-model="type" value="C1">
                                            <div class="ui-item-media"><i class="ui-icon ui-icon-form-checkbox"></i>C1</div>
                                        </label>
                                        <label class="ui-label-checkbox ui-item-content">
                                            <input type="radio" class="sex sex-girl" v-model="type" value="C2">
                                            <div class="ui-item-media"><i class="ui-icon ui-icon-form-checkbox"></i>C2</div>
                                        </label>
                                        <label class="ui-label-checkbox ui-item-content">
                                            <input type="radio" class="sex sex-girl" v-model="type" value="B2">
