        ...
        <v-footer :diy="true">
            <div slot="content">
                ...
                <div class="ui-cell btn-bottom">
                    <div class="ui-cell-primary">
                        <a style="display: inline-block;width: 20%;margin-left: 0;" href="javascript:;" @click="bidding(detail.id)">定制</a>
    ...
    methods: {
        ...
        toBuy() {
            ...
            if (coachDetailVue.bid) {
                coachDetailVue.$Confirm('确认选取该达人?', () => {
                    coachDetailVue.buy();
                });
            } else {
                coachDetailVue.buy();
